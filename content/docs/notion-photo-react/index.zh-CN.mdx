...
![1.project](https://cdn.harrly.com/web/docs/notion-photo-react/intro/1.project.png)
...
1. 要将其部署在 Vercel 上，请访问 Vercel 并单击 `New Project` 按钮。
   ...
   ![2.new-project](https://cdn.harrly.com/web/docs/notion-photo-react/intro/2.new-project.png)

2. 导入您 `fork` 的 GitHub 存储库。

   ![3.import](https://cdn.harrly.com/web/docs/notion-photo-react/intro/3.import.png)
   ...
   ![4.configure](https://cdn.harrly.com/web/docs/notion-photo-react/intro/4.configure.png)
...
![5.download](https://cdn.harrly.com/web/docs/notion-photo-react/intro/5.download.png)
